...
<html>
    ...
    <body><div class="container">
            <div class="table-responsive custom-table-responsive tm-bg-transparent-black">
                ...
                <form name="formModificarVentaPaquete" action="SvModificarVentaPaquete" method="post">
                 <table class="table custom-table" id="myTable">
                  ...
                  <tbody>
                        ...
                        for (Cliente cli: listaClientes){
                            if(cli.isHabilitado()){
                            check = "";
                                if(cli.getId_cliente() == ven.getCli().getId_cliente()){
                                    check= "checked=\"check\"";
                                } 
                        %>
                        <tr>
                ...
                <table class="table custom-table">
                  ...
                  <tbody>
                        ...
                        String check1;
                        Paquete paq1 = ven.getPaque();
                        for (Paquete paq: listaPaquetes){
                            if(paq.isHabilitado()){
                            check1 = "";
                                if(paq.getIdPaquete()== paq1.getIdPaquete()){
                                    check1= "checked=\"check\"";
                                } 
                        %>
                        <tr>
                            <% int IDPaq = paq.getIdPaquete();%>
                            <td><input name="Paqcheckbox<%=i%>" type="checkbox" class="check1" value="<%=IDPaq%> <%=check1%>"></td>
                            <td> <%=IDPaq%></td>
